...
@Component({
  ...
  template: `
    <div class="form-control pb-4 flex w-100">
      <div class="place-items-center min-w-80">
        <label class="input input-bordered flex w-100 items-center gap-2">
          <input
            [readonly]="(searchInProgress$ | async)"
            #searchInput
            type="search"
            class="grow"
            placeholder="Szukaj po firmach i nazwie"
